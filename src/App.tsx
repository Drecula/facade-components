...
function App() {
  return (
    <>
      ...
      <div className="card">
        {/* New Button */}
        <Button  isNew label='Greetings from old button' onClick={() => alert('Olde button clicked!')}/>
      </div>
      <div className="card">
        {/* Old Button */}
      ...
      {/*  /!* Old Button (VersionMapProvider only includes MyComponent, so Button remains old) *!/*/}
      {/*  <VersionMapProvider>*/}
      {/*    <Button label='Another New Button' onClick={() => alert('Another new button clicked')}/>*/}
      {/*  </VersionMapProvider>*/}
      {/*</div>*/}
    </>
  )
